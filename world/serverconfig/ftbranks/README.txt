...
Last README file update: Sun Oct 27 04:34:28 UTC 2024
...
command.ysm
command.ysm.auth
command.ysm.auth.targets
command.ysm.auth.targets.add
command.ysm.auth.targets.add.model_id
command.ysm.auth.targets.all
command.ysm.auth.targets.clear
command.ysm.auth.targets.remove
command.ysm.auth.targets.remove.model_id
command.ysm.export
command.ysm.export.model_id
command.ysm.export.model_id.extra
command.ysm.manage
command.ysm.model
command.ysm.model.export
command.ysm.model.reload
command.ysm.model.set
command.ysm.model.set.targets
command.ysm.model.set.targets.model_id
command.ysm.model.set.targets.model_id.texture_id
command.ysm.model.set.targets.model_id.texture_id.ignore_auth
command.ysm.molang
command.ysm.molang.execute
command.ysm.molang.execute.targets
command.ysm.molang.execute.targets.exp
command.ysm.ping
command.ysm.play
command.ysm.play.targets
command.ysm.play.targets.animation
command.zerocore
